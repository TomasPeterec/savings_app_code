...
export const metadata = createMetadata(
  "Terms of Use | Dreamfinery",
  "Terms and conditions for using Dreamfinery.",
  "/terms"
)
  ...
  return (
    <div className="text-page-container">
      ...
      <div className="hero-section">
        ...
        <p className="perex">Please read these terms carefully before using Dreamfinery.</p>
      </div>

      <div className="text-section">
        <h2 className="subheading">Acceptance of Terms</h2>
        <p className="paragraph">
          By accessing or using <strong className="strong-text">Dreamfinery</strong>, you agree to
          be bound by these Terms of Use. If you do not agree, you may not use the application.
        </p>

        <h2 className="subheading">Use of the Service</h2>
        <p className="paragraph">
          Dreamfinery is provided to help you plan your finances, organize your goals, and manage
          your savings.
        </p>
        <p className="paragraph">
        ...
        <p className="paragraph">
          You are responsible for the accuracy of the data you enter into Dreamfinery.
        </p>
        <p className="paragraph">
        ...
        <p className="paragraph">
          We strive to keep Dreamfinery available at all times, but we do not guarantee
          uninterrupted or error-free operation.
        </p>

        <h2 className="subheading">Limitation of Liability</h2>
        <p className="paragraph">
          <strong className="strong-text">Dreamfinery</strong> is provided "as is" without
          warranties of any kind. We are not responsible for any financial decisions or losses
